import { Container, Inject, Parent, Root, Singleton } from '../../src/index.js';
...
export class MockInjectClass {
  constructor(@Root() public root: Container, @Parent() public parent: Container, @Inject(MockValueInjector) public inject: string) {}
}
